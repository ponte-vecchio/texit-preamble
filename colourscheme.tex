...
\long\def\Apple{%
	...
	\colorlet{mercury}			{bg}
	\colorlet{liquorice}		{fg}
	\colorlet{tungsten}			{black}
	\colorlet{maraschino}		{red}
	\colorlet{fern}				{green}
	\colorlet{cantaloupe}		{yellow}
	\colorlet{blueberry}		{blue}
	\colorlet{plum}				{magenta}
	\colorlet{seafoam}			{cyan}
	\colorlet{magnesium}		{white}
	\colorlet{liquorice}		{brightblack}
	\colorlet{cayenne}			{brightred}
	\colorlet{flora}			{brightgreen}
	\colorlet{mocha}			{brightyellow}
	\colorlet{midnight}			{brightblue}
	\colorlet{maroon}			{brightmagenta}
	\colorlet{teal}				{brightcyan}
	\colorlet{mercury}			{brightwhite}
