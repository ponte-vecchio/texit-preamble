...
\newcommand{\kir@random}[1]{%
  \font\cyr@selected=\ifcase\numexpr\pdfuniformdeviate12 andk-tlf-t2a
  \or Comfortaa-Light-T2A%
  \or DroidSerif-Regular-T2A%
  \or miama-t2a%
  \or charssil-tlf-t2a%
  \or ClaraRegular-tlf-sc-t2a%
  \or OldStandard-Regular-tlf-t2a%
  \or LibertinusSerif-Regular-tlf-t2a%
