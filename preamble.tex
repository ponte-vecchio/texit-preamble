...
\usepackage[narrow,mono,var0,varqu,scaled=1.08]{zi4}
\usepackage{hwemoji}
...
\newcommand*\Apple{%
  ...
  \texit@themetrue
  \def\texit@theme{Apple}
  \texitset{pagecolor=bg, textcolor=fg}
}
...
\newcommand*\SolarisedLight{
  ...
  \def\texit@theme{Solarised Light}
  \texitset{pagecolor=bg, textcolor=fg}
}
\newcommand*\SUSEDark{
...
\ifcase\pdfuniformdeviate28 \Apple%
  \or \AyuMirage%
  \or \Breeze%
  \or \Chameleon%
  \or \Dracula%
