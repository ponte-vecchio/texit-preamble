...
\def\Catpuccin{% https://github.com/catppuccin/catppuccin
	\definecolor{fg}{HTML}{D9E0EE}
	\definecolor{bg}{HTML}{1E1D2F}
	\definecolor{black}{HTML}{6E6C7E}
	\definecolor{red}{HTML}{F28FAD}
	\definecolor{green}{HTML}{ABE9B3}
	\definecolor{yellow}{HTML}{FAE3B0}
	\definecolor{blue}{HTML}{96CDFB}
	\definecolor{magenta}{HTML}{F5C2E7}
	\definecolor{cyan}{HTML}{89DCEB}
	\definecolor{white}{HTML}{D9E0EE}
	\definecolor{brightblack}{HTML}{988BA2}
	\definecolor{brightred}{HTML}{F28FAD}
	\definecolor{brightgreen}{HTML}{ABE9B3}
	\definecolor{brightyellow}{HTML}{FAE3B0}
	\definecolor{brightblue}{HTML}{96CDFB}
	\definecolor{brightmagenta}{HTML}{F5C2E7}
	\definecolor{brightcyan}{HTML}{89DCEB}
	\definecolor{brightwhite}{HTML}{D9E0EE}
	\pagecolor{bg}\color{fg}\everymath{\color{fg}\displaystyle}
}
\def\Dracula{
...
\everydisplay\exaf{\the\everydisplay\color{fg}}
